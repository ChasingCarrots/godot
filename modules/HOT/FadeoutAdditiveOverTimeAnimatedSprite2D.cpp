...
struct InstanceData {
	FadeoutAdditiveOverTimeAnimatedSprite2D *Instance;
...
void FadeoutAdditiveOverTimeAnimatedSprite2D::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_FadeEase", "fadeEase"), &FadeoutAdditiveOverTimeAnimatedSprite2D::SetFadeEase);
	ClassDB::bind_method(D_METHOD("get_FadeEase"), &FadeoutAdditiveOverTimeAnimatedSprite2D::GetFadeEase);
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "FadeEase"), "set_FadeEase", "get_FadeEase");

	ClassDB::bind_method(D_METHOD("set_UseFixedLifetime", "useFixedLifetime"), &FadeoutAdditiveOverTimeAnimatedSprite2D::SetUseFixedLifetime);
	ClassDB::bind_method(D_METHOD("get_UseFixedLifetime"), &FadeoutAdditiveOverTimeAnimatedSprite2D::GetUseFixedLifetime);
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "UseFixedLifetime"), "set_UseFixedLifetime", "get_UseFixedLifetime");

	ClassDB::bind_method(D_METHOD("set_Lifetime", "lifetime"), &FadeoutAdditiveOverTimeAnimatedSprite2D::SetLifetime);
	ClassDB::bind_method(D_METHOD("get_Lifetime"), &FadeoutAdditiveOverTimeAnimatedSprite2D::GetLifetime);
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "Lifetime"), "set_Lifetime", "get_Lifetime");

	ClassDB::bind_method(D_METHOD("_on_bullet_on_time_reduced", "remainingTimeFactor"), &FadeoutAdditiveOverTimeAnimatedSprite2D::_on_bullet_on_time_reduced);

	ClassDB::bind_static_method("FadeoutAdditiveOverTimeAnimatedSprite2D", D_METHOD("updateAll", "delta"), &FadeoutAdditiveOverTimeAnimatedSprite2D::updateAll);
	ClassDB::bind_static_method("FadeoutAdditiveOverTimeAnimatedSprite2D", D_METHOD("clearAll"), &FadeoutAdditiveOverTimeAnimatedSprite2D::clearAll);
}

void FadeoutAdditiveOverTimeAnimatedSprite2D::_notification(int p_notification) {
...
void FadeoutAdditiveOverTimeAnimatedSprite2D::_ready() {
	PROFILE_FUNCTION()
...
void FadeoutAdditiveOverTimeAnimatedSprite2D::_exit_tree() {
	PROFILE_FUNCTION()
	if(UseFixedLifetime) {
...
void FadeoutAdditiveOverTimeAnimatedSprite2D::updateAll(float delta) {
	PROFILE_FUNCTION()
...
void FadeoutAdditiveOverTimeAnimatedSprite2D::clearAll() {
	Instances.clear();
}

void FadeoutAdditiveOverTimeAnimatedSprite2D::_on_bullet_on_time_reduced(float remainingTimeFactor) {
