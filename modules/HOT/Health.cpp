...
void Health::_bind_methods() {
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "ModifierCategories"), "set_ModifierCategories", "get_ModifierCategories");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "StartHealth"), "set_StartHealth", "get_StartHealth");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "DestroyWhenKilled"), "set_DestroyWhenKilled", "get_DestroyWhenKilled");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "InvincibilityTimeWhenDamaged"), "set_InvincibilityTimeWhenDamaged", "get_InvincibilityTimeWhenDamaged");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "InitialInvincibilityTime"), "set_InitialInvincibilityTime", "get_InitialInvincibilityTime");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "BaseChanceToBlock"), "set_BaseChanceToBlock", "get_BaseChanceToBlock");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "BaseBlockValue"), "set_BaseBlockValue", "get_BaseBlockValue");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "InterruptPiercing"), "set_InterruptPiercing", "get_InterruptPiercing");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "ShowDamageNumbers"), "set_ShowDamageNumbers", "get_ShowDamageNumbers");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "ShowHealNumbers"), "set_ShowHealNumbers", "get_ShowHealNumbers");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "AddsToKillCount"), "set_AddsToKillCount", "get_AddsToKillCount");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "KillAfterNumberOfHits"), "set_KillAfterNumberOfHits", "get_KillAfterNumberOfHits");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "BaseDamageFactor"), "set_BaseDamageFactor", "get_BaseDamageFactor");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "HealOnLevelUp"), "set_HealOnLevelUp", "get_HealOnLevelUp");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "BaseRegenerationPerSecond"), "set_BaseRegenerationPerSecond", "get_BaseRegenerationPerSecond");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "BaseDefense"), "set_BaseDefense", "get_BaseDefense");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "_currentHealth", PROPERTY_HINT_NONE, "", PROPERTY_USAGE_NONE), "set_CurrentHealth", "get_CurrentHealth");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "_invincibilityStacks", PROPERTY_HINT_NONE, "", PROPERTY_USAGE_NONE), "set_InvincibilityStacks", "get_InvincibilityStacks");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "_remainingInvincibilityAfterDamage", PROPERTY_HINT_NONE, "", PROPERTY_USAGE_NONE), "set_RemainingInvincibilityAfterDamage", "get_RemainingInvincibilityAfterDamage");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "_damageTakenBeforeInvincibility", PROPERTY_HINT_NONE, "", PROPERTY_USAGE_NONE), "set_DamageTakenBeforeInvincibility", "get_DamageTakenBeforeInvincibility");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "_hitCount", PROPERTY_HINT_NONE, "", PROPERTY_USAGE_NONE), "set_HitCount", "get_HitCount");
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING, "_regenBucket", PROPERTY_HINT_NONE, "", PROPERTY_USAGE_NONE), "set_RegenBucket", "get_RegenBucket");
