...
public:
	...
	void set_worldPosition(Vector2 newWorldPos) { if(!_gameObject.is_valid()){return;}; set_global_position(newWorldPos); _gameObject->set_tracked_global_position(get_global_position()); }
